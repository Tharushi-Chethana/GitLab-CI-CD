...
- This repository mirrors my **course learning journey**.  
- Each `.gitlab-ci.yml` file corresponds to a specific section of the course, allowing me to track progress step by step.  
- In real-world projects, I maintain a **single `.gitlab-ci.yml` file** with proper version control practices in GitLab.
...
## 📌 Additional Notes  
- All commits are made in **GitLab**, and this GitHub repository is synced via **mirror push**.  
- This structure was chosen to document each section of the GitLab CI/CD course for reference and learning purposes.
